<?php if( get_row_layout() == 'callout_section' ) {
			...
			<div class="innerContent">
				<?php if ($top_image) { ?>
					<figure class="topimage">
						<img src="<?php echo $top_image['url']?>" alt="<?php echo $top_image['title']?>" />
					</figure>
				<?php } ?>
				<?php if ($text) { ?>
				...
				<div class="buttons align-center">
					<?php foreach($buttons as $b) {
						...
						if( $btnTitle && $btnLink ) { ?>
							<a href="<?php echo $btnLink ?>" target="<?php echo $btnTarget ?>" class="button btn-wide"><?php echo $btnTitle ?></a>
						<?php } ?>
					<?php } ?>
				</div>
				<?php } ?>
